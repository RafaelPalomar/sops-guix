...
;;; Copyright © 2026 Rafael Palomar

;;; Local fork to support Guix commits that predate 24a33681 (gnu: Add sops),
;;; where the sops package is not yet in (gnu packages password-utils).
;;; This restores the trivial binary-based definition from commit 3349aed.
